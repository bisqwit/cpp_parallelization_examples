...
extern bool SimdCalculation(bool NeedMoment, double zr,double zi,double xscale,double yscale, unsigned* pixels);
template<bool WithMoment>
...
struct NativeTask: public Task
{
    ...
    NativeTask() : thread([this]()
    {
        ...
        for(;;)
        {
            ...
            NeedMoment = SimdCalculation(NeedMoment, zr,zi,xscale,yscale, &pixels[0]);
